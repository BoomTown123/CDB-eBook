...
>
> Reference: [6 Questions Before Choosing a Model](../../../frameworks/6-questions-before-choosing-a-model.md) | [7 Failure Modes of Agents](../../../frameworks/7-failure-modes-of-agents.md)

## Prompts in This Collection

| Prompt File | Use Case | Related Framework |
|-------------|----------|-------------------|
| [Model Comparison Prompts](model-comparison-prompts.md) | Comparing outputs from different models on the same task | [6 Questions Before Choosing a Model](../../../frameworks/6-questions-before-choosing-a-model.md) |
| [Quality Evaluation Prompts](quality-eval-prompts.md) | Scoring output quality across multiple dimensions | [8 Patterns for AI Coding](../../../frameworks/8-patterns-for-ai-coding.md) |
| [Safety Evaluation Prompts](safety-eval-prompts.md) | Testing for safety, alignment, and policy compliance | [7 AI Risks and Mitigations](../../../frameworks/7-ai-risks-and-mitigations.md) |
...
- [6 Questions Before Choosing a Model](../../../frameworks/6-questions-before-choosing-a-model.md) -- the decision framework these prompts support
- [Permission Model Framework](../../../frameworks/permission-model-framework.md) -- autonomy levels that safety evals should verify
