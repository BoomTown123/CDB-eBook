...
- Which resource file it belongs in (e.g., `resources/tools.md`)
- A brief description of why it is relevant
...
3. Ensure all relative links in your changes resolve correctly.
4. Write a clear pull request description explaining what you changed and why.
...
By contributing to this repository, you agree that your contributions will be licensed under the [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)](LICENSE) license, the same license that covers the rest of this repository.
