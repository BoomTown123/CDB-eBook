...
### [Chapter 8: Teams for AI-First Companies](./08-teams-for-ai-first-companies/README.md)
Structuring teams for AI-first success. The org chart changes, hiring shifts, and the 90-day AI fluency program.

### [Chapter 9: Data Strategy — Flywheels, Moats, and Ethics](./09-data-strategy/README.md)
Building data advantages that compound. Data flywheels, polyglot persistence in practice, and privacy by design.

### [Chapter 10: AI-Augmented Operations and Go-to-Market](./10-ai-augmented-operations-and-gtm/README.md)
